...
| :--- | :--- | :--- | :--- |
| **ST-30** | `StrengthTypologyTestController` | Identifikasi 30 tipologi kekuatan secara cepat. | Pengguna Gratis/Trial |
| **Full TM** | `QuizController` | Asesmen lengkap 34 bakat (TM + PSS + GRIT). | Pengguna Berbayar (Retail) |
| **Partner Assessment** | `PartnerAssessmentController` | Asesmen yang didistribusikan via kode referensi. | Karyawan/Siswa (B2B) |
